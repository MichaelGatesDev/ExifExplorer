...
public class SmallerThanApertureCriteria extends ApertureCriteria
{
    public SmallerThanApertureCriteria(Aperture aperture)
    {
        super(ApertureCriteriaCondition.SMALLER_THAN, new Aperture[]{ aperture });
    }
