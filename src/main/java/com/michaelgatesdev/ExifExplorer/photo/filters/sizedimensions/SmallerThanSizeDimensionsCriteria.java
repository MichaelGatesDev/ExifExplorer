...
public class SmallerThanSizeDimensionsCriteria extends SizeDimensionsCriteria
{
    public SmallerThanSizeDimensionsCriteria(SizeDimensions dimensions)
    {
        super(SizeDimensionsCriteriaCondition.SMALLER_THAN, new SizeDimensions[]{ dimensions });
    }
